...
<body>
    ...
    <div id="menu_default"><menu id="menu-default">
                            <a href="">HOME</a>
                            <a href="sobre">SOBRE A BETINA</a> 
                            <!--<li><a href="dicas">Dicas e Novidades</a></li>-->
                            <a href="cadastro">CADASTRO/LOGIN</a> 
                            <!--<a href="cadastro">COMO FAZER SUA COTAÇÃO</a>-->
                            <a href="cesta">CESTA DE COTAÇÕES</a> 
            	...
            	<div class="duas-colunas">
                                ...
                                <tr>
                                    ...
                                    <td width="30%" ><div id="telefones-wid">
                                       <!--  <h4 class="yellow-text">Betina Entrega Rápida</h4>
                                        ...
                                        </table> --> <img src="lib/img/bb2.png" alt=""/> </div></td>
                                    ...
                                    <img src="lib/img/bb3.jpg" alt=""/></div></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="right">
                       <!--<ul id="menu-principal">
                            ...
                            <li><a href="cadastro">COMO FAZER SUA COTAÇÃO</a></li>
                       ...
                       <h2>Dicas e Novidades</h2>
                        ...
                        <p><img src="lib/img/bl1.jpg" margin="0" alt=""/></p>
                        <p><img src="lib/img/bl2.jpg" margin="0" alt=""/></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="footer">
    	<div class="wrap duas-colunas">
       		<div class="left">
       			<a href=""><img src="lib/img/betina.png" width="180" height="99" alt=""/></a><span class="white-text">Todos os direitos reservados - Betina Limpeza</span>
       		</div>
        	
            	
            
            <div class="right">
				<a href=""><img src="lib/img/rossi.png" width="263" height="49" alt=""/></a>
            </div>
        </div>
    </div>
